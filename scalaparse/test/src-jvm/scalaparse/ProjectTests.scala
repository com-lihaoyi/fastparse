...
object ProjectTests extends TestSuite{
  ...
  def tests = this{
    ...
    "akka/akka"- checkRepo(
      ...
      _ != "out/repos/akka/akka-stream-tests/src/test/scala/akka/stream/scaladsl/FlowGroupedWithinSpec.scala"
    )
    ...
    "sbt/sbt" - checkRepo(
      ...
      x => !Seq(
        ...
        "out/repos/sbt/main-settings/src/main/scala/sbt/std/InputWrapper.scala",
        // uses a package called `macro`
        "out/repos/sbt/sbt/src/sbt-test/source-dependencies/inherited-macros",
        "out/repos/sbt/sbt/src/sbt-test/source-dependencies/macro"
      ).exists(x.startsWith)
    )
    ...
    "ornicar/lila" - checkRepo(
      ...
      x => !Seq(
        "out/repos/lila/modules/lobby/src/main/SocketHandler.scala"
      ).exists(x.startsWith)
    )
    ...
    "JetBrains/intellij-scala" - checkRepo(
      ...
      x => !Seq(
        ...
        "out/repos/intellij-scala/scala/scala-impl/testdata/scalacTests/failed/t389.scala"
      ).exists(x.startsWith)
    )
    "scalatest/scalatest" - checkRepo(
      ...
      x => !Seq(
        // Unicode escapes in weird places
        "out/repos/scalatest/common-test/src/main/scala/org/scalatest/OperatorNames.scala",
        "out/repos/scalatest/scalatest-test/src/test/scala/org/scalatest/OperatorNames.scala"
      ).exists(x.startsWith)
    )
...
//      ).exists(x.startsWith))
    ...
    "scala/scala" - checkRepo(
      ...
      x => !Seq(
        ...
        "out/repos/scala/test/files/neg/t5510.scala",
        // Unicode escapes in weird places
        "out/repos/scala/test/files/neg/t8015-ffb.scala",
        "out/repos/scala/test/files/pos/t389.scala",
        "out/repos/scala/test/files/run/literals.scala",
        "out/repos/scala/test/files/run/t3835.scala",
        // Scalac parser seems to accept this, though it blows up later
        "out/repos/scala/test/files/neg/t8266-invalid-interp.scala",
        "out/repos/scala/test/disabled/",
        "out/repos/scala/test/files/neg/",
        // trailing . after number
        "out/repos/scala/test/files/presentation/infix-completion/src/Snippet.scala",
        // Not sure why this is failing but it's new, and earlier version of Scalaparse fail too
        "out/repos/scala/src/scaladoc/scala/tools/nsc/doc/html/page/Entity.scala",
        "out/repos/scala/src/scaladoc/scala/tools/nsc/doc/html/HtmlPage.scala",
        "out/repos/scala/src/scaladoc/scala/tools/nsc/doc/html/page/Template.scala"
      ).exists(x.startsWith)
    )
